...
@st.cache_resource
def load_model():
    return AutoModelForSeq2SeqLM.from_pretrained(FINETUNED_MODEL_DIR)

@st.cache_resource
def load_tokenizer():
    return AutoTokenizer.from_pretrained(FINETUNED_MODEL_DIR)
...
with st.spinner('Loading model...'):
    ...
    finetuned_tokenizer = load_tokenizer()
